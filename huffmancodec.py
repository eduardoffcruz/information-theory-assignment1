...
def main():
    ...
    codec = HuffmanCodec.from_data([101, 102, 101, 102, 101, 102, 101, 100, 100, 104,_EOF])
    t = codec.get_code_table() #returns dictionary mapping symbol to code tuple (bitsize, value)
    #ou seja, considerando que o array contém os valores do alphabeto(letters) a1 a2 a3 a4, 
    #o dicionario obtido da função get_code_table() inclui por exemplo:  a1:(length de bits de c(a1) , c(a1) em decimal)
    #em que c(a1) é o codeword de a1 (codificaçao de a1). 
    #exemplo mais concreto: 101 vai ser codificado com o valor 0 q tem comprimento 1
    #104 cai ser codificado com o valor 6(decimal) == 110(binario) que tem comprimento 3
    print(t) #tabela de huffman!! muito importante
    s, l = codec.get_code_len()
    print(s)
    print(codec.encode([101, 102, 101, 102, 101, 102, 101, 100, 100, 104]))
    print(codec.decode(codec.encode([101, 102, 101, 102, 101, 102, 101, 100, 100, 104])))
    print(l) #array com comprimento (nr de bits) respetivo de cada símbolo do array s
